...
public class GastronomyItems {
    ...
    public static final RegistryObject<Item> MIXED_JUICe = ITEMS.register("mixed_juice", () -> new PenguinItem(new PenguinItem.Properties().useAction(UseAction.DRINK).food(GastronomyFoods.VEGETABLE_JUICE).tab(Gastronomy.TAB)));
