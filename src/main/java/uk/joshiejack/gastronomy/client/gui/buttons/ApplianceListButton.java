...
//
//@OnlyIn(Dist.CLIENT)
//public class ApplianceListButton extends BookButton {
//    private final Appliance appliance;
//    private final ItemStack stack;
//
//    public ApplianceListButton(Appliance appliance, BookScreen gui, int buttonId, int x, int y, String buttonText) {
