...
//
//@OnlyIn(Dist.CLIENT)
//public class RecipeListingButton extends BookButton {
//    private final PageRecipe page;
//    private final Recipe recipe;
//    private final ItemStack stack;
//    private final boolean isInInventory;
//
//    public RecipeListingButton(PageRecipe page, BookScreen gui, int buttonId, int x, int y, String string, NonNullList<ItemStack> stacks, List<FluidStack> fluids) {
