...
@OnlyIn(Dist.CLIENT)
@PenguinLoader(value = "oven", side = Dist.CLIENT)
public class SpecialRendererOven extends SpecialRendererCookware<OvenTileEntity> {
    ...
    @Override
    public void render(OvenTileEntity oven, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        if (destroyStage >= 0) {
